...
export default async function WatchPage({
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#050505] text-white selection:bg-[#ffa31a] selection:text-black">
      ...
      <main className="relative z-10 mx-auto max-w-400 p-4 pt-24 md:p-8 md:pt-28 lg:px-10 xl:px-12">
        <Link
          href="/"
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start xl:gap-12">
          <div className="space-y-8">
            {/* Player Container */}
            <div className="group relative aspect-video w-full overflow-hidden rounded-2xl border border-white/10 bg-black shadow-[0_0_24px_rgba(255,163,26,0.14)]">
              <iframe
                src={streamUrl}
              ...
              <div className="space-y-4 pt-8 border-t border-white/10">
                ...
                <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                  {details.cast.slice(0, 10).map((actor: CastMember) => (
                    <div
                      key={actor.id}
                      className="flex shrink-0 flex-col gap-2 w-24 text-center"
                    >
